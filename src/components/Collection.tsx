      ...
      <Card className="col-span-12 sm:col-span-4 h-[500px]">
        <CardHeader className="absolute z-10 bottom-1 right-1 flex-col  !items-end">
          <div className=" flex flex-col gap-2">
            <p className="text-tiny w-fit  bg-white rounded-full px-3 py-1 uppercase font-bold">
              Elegance in Knits
            </p>
            <h4 className="bg-white  rounded-bl-full rounded-tr-full   px-3  marker:  font-medium text-large">
              The Winter Wonderland Sweater
            </h4>
          </div>
        </CardHeader>
